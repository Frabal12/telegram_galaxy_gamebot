    ...
    default void chose(String messageText) throws TelegramApiException, IOException, ClassNotFoundException, TransitionNotFoundException, InterruptedException {
        switch (messageText) {
            ...
            case "/start", "Menù":
                startG();
                break;
            case "Mercante Locale":
                choseView();
                break;
            case "/play", "Mercante", "Combattente", "Guardiano":
                chosePlayer();
                break;
            case "Statistiche giocatore":
                stats();
                break;
            case "Cerca materiali":
                mine();
                break;
            case "Usa il condensatore":
                condense();
                break;
            case "Genera Pietra":
                generates();
                break;
            case "Migliora un'arma":
                powerUp();
                break;
            case "Combatti":
                combat();
            ...
            case "Analizza":
                analysis();
                break;
            case "Esplora il pianeta":
                explore();
                break;
            case "Equipaggia":
                equip();
                break;
            case "Ricarica Proiettili":
                refill();
                break;
            case "Oro", "Ferro", "Roccia":
                choseMaterial();
                break;
            case "SI", "NO":
                buy();
                break;
            case "Parte Superiore", "Manico":
                choseParts();
                break;
            case "Visuale a lista", "Visuale a scorrimento":
                changeView();
                break;
            default:
                unknown();
